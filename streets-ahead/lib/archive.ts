...
export const archiveItems: ArchiveItem[] = [
  {
    ...
    body: [
      'Manchester International Arts (MIA) was created in 1988 by Anne Tucker and Jeremy Shine to present international, multi-cultural and animatory street art events and festivals in Greater Manchester.',
      'Early projects included Ona Catalana, a celebration of Catalan street culture, laying the foundations for the large city-centre festivals that would follow.',
    ],
  },
  {
  ...
  },
  {
    ...
    summary:
      'The flagship festival: international street arts filling the squares and streets of Manchester every summer.',
    body: [
      ...
      'The festival brought many of the most wonderful, engaging, imaginative and colourful street theatre companies from the UK and overseas — often for the first time — to Greater Manchester, animating shops, cafés, squares and open spaces.',
  ...
  },
  {
    ...
    place: 'Cumbria',
    era: 'Beyond Manchester',
    art: 'linear-gradient(60deg, #001317 0%, #7d8688 60%, #fafafa 100%)',
    summary: 'High-energy outdoor spectacle from the Lakes Alive programme.',
    body: [
      'Hypervelocity was presented as part of the Lakes Alive programme, which each year brought a multitude of events and festivals to the Cumbrian landscape.',
    ],
  },
  {
    slug: 'mobile-homme',
